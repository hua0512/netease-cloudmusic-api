...
interface ITrack : INeteaseApi {
   ...
   *
   */
  suspend fun getTracksUrl(ids: List<String>, br: Long? = 999000): NetworkResponse<TracksInfo, FailedResponse>

  suspend fun getTracksUrlV1(
    ids: List<String>,
    level: NeteaseTrackLevel? = NeteaseTrackLevel.EXHIGH,
  ): NetworkResponse<TracksInfo, FailedResponse>

  suspend fun isPlayable(ids: List<String>, br: Long? = 999000): NetworkResponse<TracksInfo, FailedResponse>
}
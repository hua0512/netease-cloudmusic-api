...
class PlaylistImpl(client: HttpClient) : BaseNeteaseNetworkImpl(client), IPlaylist {
      ...
      when (this) {
        is NetworkResponse.Success -> {
          ...
          val urls = jsonData.jsonObject.entries.mapNotNull {
            ...
            NeteaseBatchResponse.Single(it.key).apply {
              this.code = response.code
            }
          }
          return NetworkResponse.Success(NeteaseBatchResponse.Multiple(urls), this.headers, code)
        }
  ...
  override suspend fun getHighQualityPlaylists(
    ...
    limit: Int?,
    before: Long?,
  ): NetworkResponse<HighQualityPlaylist, FailedResponse> {
  ...
  override suspend fun getPlaylistDetail(id: String, subscribers: Int?): NetworkResponse<PlaylistDetail, FailedResponse> {
  ...
  override suspend fun getPlaylistTracks(id: String, limit: Int?, offset: Int?): NetworkResponse<PlaylistTracks, FailedResponse> {

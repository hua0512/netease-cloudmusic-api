...
interface IPlaylist {
    ...
    suspend fun getHighQualityPlaylists(
        ...
        limit: Int? = 50,
        before: Long? = 0
    ): NetworkResponse<NeteasePlaylistResponse.NeteaseHighQualityPlaylistResponse, FailedResponse>
    ...
    suspend fun getTopPlaylists(
        ...
        limit: Int? = 50,
        offset: Int? = 0
    ): NetworkResponse<NeteaseTopPlaylistResponse, FailedResponse>
     ...
     */
    suspend fun getPlaylistDetail(id: String, subscribers: Int? = 8): NetworkResponse<NeteasePlaylistDetailResponse, FailedResponse>
     ...
     * @return 歌单所有歌曲
     */
    suspend fun getPlaylistTracks(id: String, limit: Int? = null, offset: Int? = null): NetworkResponse<NeteasePlaylistTracksResponse, FailedResponse>
